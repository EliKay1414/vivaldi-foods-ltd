...
const slides = [
  {
    eyebrow: '100% Pure Honey',
    title: "Freshly sourced from the\nVolta Region",
    subtitle: 'Vivaldi Foods Ltd brings you safe, 100% real honey straight from our beekeepers in the Volta Region.',
  ...
  {
    eyebrow: 'Pure & Tested Honey',
    title: 'Carefully Checked\n& Bottled Clean',
    subtitle: 'Every bottle is tested to make sure it is fresh, clean, and safe for you and your family.',
    cta1: { label: 'Shop Now', href: '/products' },
    textColor: 'text-white',
    overlay: 'bg-black/60',
    btnColor: 'bg-green-700 hover:bg-green-800',
  ...
  {
    eyebrow: 'Care for Our Bees',
    title: 'Kind Beekeeping\nIn Every Drop',
    subtitle: 'We care for our bees and keep the forest safe so you get sweet, natural honey.',
    cta1: { label: 'Shop Now', href: '/products' },
    textColor: 'text-white',
    overlay: 'bg-black/50',
    btnColor: 'bg-green-700 hover:bg-green-800',
  ...
  {
    eyebrow: 'Helping Local Farmers',
    title: 'Supporting Our\nLocal Beekeepers',
    subtitle: 'We work with local beekeepers and farming families across Volta and Oti to help them grow.',
    cta1: { label: 'Shop Now', href: '/products' },
    textColor: 'text-white',
    overlay: 'bg-black/50',
    btnColor: 'bg-green-700 hover:bg-green-800',
  ...
  },
  {
    ...
    title: 'For Homes, Supermarkets\n& Retail Shops',
    subtitle: 'Clean, sweet, and healthy honey ready for homes, shops, and supermarkets across Ghana.',
    cta1: { label: 'Shop Now', href: '/products' },
