  ...
  return (
    <div className="min-h-screen bg-brand-cream pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 selection:bg-amber-100 selection:text-amber-900">
      <Seo
        ...
        description="Create your Vivaldi customer account for fast ordering, live delivery updates, and saved addresses."
      />
          ...
          <div className="relative z-10 space-y-6 max-w-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                Create your customer account for fast ordering, doorstep delivery tracking, and easy reorders.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full space-y-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Register once to manage your orders, delivery preferences, and wishlist.
              </p>
            </div>
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="absolute bg-white px-3 text-[11px] font-bold uppercase tracking-wider text-gray-400">
                Or fill in your account details
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="phone" className="block text-xs font-bold text-gray-700">
                    Ghana Phone Number <span className="text-red-500">*</span>
                  </label>
                  <div className="relative rounded-xl border border-gray-200 bg-gray-50/50 hover:bg-white focus-within:bg-white focus-within:border-green-700 focus-within:ring-3 focus-within:ring-green-700/10 transition-all">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                      <Phone size={16} />
              ...
              {/* Row 4: Default Delivery Address / Landmark */}
              <div className="space-y-1.5">
                <label htmlFor="deliveryAddress" className="block text-xs font-bold text-gray-700">
                  Default Delivery Landmark or Street Address <span className="text-gray-400 font-normal">(Optional)</span>
                </label>
                <div className="relative rounded-xl border border-gray-200 bg-gray-50/50 hover:bg-white focus-within:bg-white focus-within:border-green-700 focus-within:ring-3 focus-within:ring-green-700/10 transition-all">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                    <Truck size={16} />
                  ...
                  <input
                    ...
                    placeholder="Near Shell Filling Station, Sakumono Estate or House #12 East Legon"
                    className="w-full pl-10 pr-3.5 py-2.5 bg-transparent text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none"
                  />
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-7 shadow-2xl border border-gray-100 space-y-4 animate-scale-in text-sm leading-normal">
            <div className="flex items-center justify-between pb-3 border-b border-gray-100">
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-bold text-base text-gray-900">Sign up with Google</span>
              </div>
              <button
                type="button"
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Enter your Google (Gmail) address to instantly create or link your customer profile with Vivaldi Foods.
            </p>

            <form onSubmit={handleGoogleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="reg-google-email" className="block text-xs font-bold text-gray-700">
